...
module.exports = function (assertion, cert, thumbprint) {
    var xml = assertion.xml;
    ...
    signed.keyInfoProvider = {
        ...
        getKey: function (keyInfo) {
            if (thumbprint)  {
                ...
                var embeddedSignature = assertion.signature.X509CertificategetElementsByTagName("ds:X509Certificate");
                // console.log('embeddedSignature', embeddedSignature);
